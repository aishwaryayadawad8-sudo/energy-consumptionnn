...
"""
Restore the original FontAwesome icons with the ultra-unique effects
"""

def restore_original_icons():
    """Restore FontAwesome icons while keeping the unique effects"""
    ...
    try:
        ...
        # Find and replace the navigation HTML back to FontAwesome icons
        ...
        if html_start_index != -1:
            ...
            if html_end_index != -1:
                ...
                # Restore original FontAwesome icon HTML
                original_html = '''<div class="nav-icons-row">
            ...
            <a href="{% url 'comprehensive_comparison_dashboard' %}" class="nav-icon-item">
                ...
                content = before_html + original_html + after_html
        
        # Now update the CSS to work with FontAwesome icons but keep the unique effects
        old_css_start = '        /* Realistic 3D Navigation Icons */'
        ...
        if start_index != -1:
                ...
                if char == '{':
                    ...
                    if in_nav_section and brace_count == 0:
                        ...
                        if '\n        @media' in next_section or '\n        .' in next_section or '\n        /*' in next_section:
                            if '/* Realistic' not in next_section[:50]:
                                end_offset = i + 1
                                break
            ...
            if end_offset > 0:
                ...
                # Create CSS that works with FontAwesome icons but keeps unique effects
                restored_css = '''        /* Ultra-Unique Navigation - Holographic Energy System */
        ...
        @media (max-width: 576px) {
            ...
            .navigation-icons-section::after {
                ...
                new_content = before_css + restored_css + after_css
                
                # Write the updated content
                with open(template_path, 'w', encoding='utf-8') as f:
                    f.write(new_content)
                
                print("✅ Successfully restored original FontAwesome icons!")
                print("\n🎯 Restored Features:")
                print("   ⚡ FontAwesome bolt icon for Total Energy")
                print("   🔌 FontAwesome plug icon for Electricity")
                print("   🍃 FontAwesome leaf icon for Renewables")
                print("   💨 FontAwesome smog icon for CO₂ Emissions")
                print("   🌍 FontAwesome globe icon for Country Forecasts")
                print("   ➡️ FontAwesome arrow icon for More Projections")
                print("\n✨ Kept All Unique Effects:")
                print("   - Holographic energy fields")
                ...
                print("\n🚀 Best of both worlds - FontAwesome icons with unique effects!")
        ...
        print(f"❌ Error restoring original icons: {e}")
        import traceback
        traceback.print_exc()
