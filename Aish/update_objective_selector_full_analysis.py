...
new_section = '''        <!-- Featured: Full Analysis (Dashboard + ML Comparison) -->
        <div class="row mb-4">
            <div class="col-12">
...
print("✅ Objective selector updated successfully!")
print("📄 Added 'Complete SDG 7 Analysis' as the featured option")
print("🔗 Links to: /full-analysis/")
