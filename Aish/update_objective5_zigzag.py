#!/usr/bin/env python3
"""
Update Objective 5 with zigzag layout for charts
"""
...
for sub_no, (model_name, val) in best_models.items():
    print(f"Sub-objective {sub_no}: {model_name} ({val:.4f})")</pre>
        ...
        <div id="chartsContainer">
            ...
            <div class="zigzag-row zigzag-left">
                ...
                <div class="zigzag-content">
                    ...
                    <div class="best-model-badge">
                        <i class="fas fa-star"></i> Best Model: CatBoost (MSE = 0.0047)
                    </div>
            ...
            <div class="zigzag-row zigzag-right" id="historicalRow" style="display: none;">
            ...
            <!-- Chart 3: Future Predictions (Left) -->
            <div class="zigzag-row zigzag-left" id="predictionsRow" style="display: none;">
    ...
    <script>
        ...
        function renderHistoricalChart(data, country) {
            document.getElementById('historicalRow').style.display = 'flex';
            ...
            historicalChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: `${country} - Electricity Access (%)`,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: `Historical Electricity Access - ${country}`,
                            font: { size: 16, weight: 'bold' }
                        }
                    },
                    scales: {
...
print("✅ Objective 5 now has ZIGZAG layout:")
print("   📊 Chart 1 (Model Comparison) - LEFT side with number '1'")
print("   📈 Chart 2 (Historical Data) - RIGHT side with number '2'")
print("   🔮 Chart 3 (Future Predictions) - LEFT side with number '3'")
print("\n✨ Features:")
print("   - Alternating left-right layout")
print("   - Large numbers (1, 2, 3) beside each chart")
print("   - Data persistence (same country = same data)")
print("   - Responsive design")
print("\n🚀 Restart your Django server and visit /objective5/ to see the zigzag layout!")
