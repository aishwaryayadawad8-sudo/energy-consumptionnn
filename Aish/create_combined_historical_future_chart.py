#!/usr/bin/env python3
"""
Create combined historical + future chart for Objective 3
Exactly like the screenshot you showed
"""

def create_combined_chart_template():
    """Create the combined historical + future chart template"""
...
<body>
                ...
                .then(allData => {
                    ...
                    return fetch(`/api/objective3/predictions/?country=${encodeURIComponent(country)}&years=10`)
                        ...
                        .then(predData => {
                            ...
                            // Create combined traces for all countries
                            const traces = [];
                            
                            // Add historical traces for all countries
                            ...
                            Plotly.newPlot('combinedPlot', traces, layout, {responsive: true});
                            
                            showMessage('success', `Combined analysis complete for ${country}!`);
                        });
                })
                .catch(err => {
    ...
    print("✅ Created combined historical + future chart for Objective 3")

def main():
    print("🔧 Creating Combined Historical + Future Chart")
    print("="*50)
    
    create_combined_chart_template()
    
    print("\n📊 New Combined Chart Features:")
    print("✅ Single chart with historical + future data")
    print("✅ Access levels: Low, Medium, High (like your screenshot)")
    print("✅ Country legend on the right side")
    print("✅ Selected country highlighted prominently")
    print("✅ Future predictions shown as dashed line")
    print("✅ Timeline from 2000 to 2030+")
    print("✅ Click legend to show/hide countries")
    
    print("\n🎯 Chart Layout (matches your screenshot):")
    print("- Y-axis: Access Level (Low/Medium/High)")
    print("- X-axis: Year (2000-2030+)")
    print("- Historical data: solid lines")
    print("- Future predictions: dashed lines")
    print("- Selected country: thick blue line")
    print("- Predictions: thick pink dashed line")
    print("- Legend: right side with all countries")
    ...
    print("5. See combined historical + future chart")
