...
print("Objective 2 HTML file updated with hardcoded MSE values!")
print("Values used:")
print("  Linear Regression: 0.0370")
print("  Decision Tree: 0.0085")
print("  KNN: 0.0089")
print("  XGBoost: 0.0048 (Best)")
print("  LightGBM: 0.0349")
print("  CatBoost: 0.0072")
print("  Random Forest: 0.0074")
