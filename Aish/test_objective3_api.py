#!/usr/bin/env python3
"""
Test Objective 3 API
"""
import requests

def test_objective3_api():
    """Test Objective 3 API endpoints"""
    base_url = "http://127.0.0.1:8000"
    
    print("🚀 Testing Objective 3 API...")
    print("=" * 50)
    ...
    try:
        response = requests.get(f"{base_url}/api/objective3/historical/?country=Australia", timeout=5)
        if response.status_code == 200:
            data = response.json()
