...
<body>
    ...
    <script>
        ...
        function loadModelComparison() {
            ...
            fetch('/api/objective2/model-comparison/')
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        modelOrder.forEach(model => {
                            if (data.mse_scores[model] !== undefined) {
                                models.push(model);
                                mseValues.push(data.mse_scores[model]);
...
print("Objective 2 HTML file created successfully!")
